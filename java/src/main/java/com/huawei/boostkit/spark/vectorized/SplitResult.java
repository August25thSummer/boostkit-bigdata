/**
 * Licensed to the Apache Software Foundation (AST) under one or more
 * contributor license agreements. See the NOTICE file distributed with
 * this work for additional information regarding copyright ownership.
 * The ASF license this file to you under the Apache License, Version 2.0
...
public class SplitResult {
    ...
    public SplitResult(long totalComputePidTime, long totalWriteTime, long totalSpillTime, long totalBytesWritten, long totalBytesSpilled, long[] partitionLengths) {
